...
# ~ model = Model(temperature = temp,
              # ~ step_number = 300001, initial_step_number = 50000, exposure_time = 50,
              # ~ C_size = 7, C_field_strength = 0.000, C_mass_strength = 0.4,
              # ~ real_space_images_to_save = 300, gen_new_fields = True)
...
# ~ make_plots(save_name = temp, fit_in = 80, fit_out = 25)
